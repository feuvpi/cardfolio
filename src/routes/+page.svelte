  ...
  <Heading/>
    ...
    >
      <div class="mx-auto max-w-3xl text-center">
        <h1
          class="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl font-mono"
        >
        Centralize and share.
  
          <span class="sm:block font-mono"> Showcase anything you want. </span>
        </h1>
